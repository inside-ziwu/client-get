...
const sharedPreset = {
  ...
  theme: {
    extend: {
      ...
      width: {
        'ui-control-small': 'var(--ui-control-width-small)',
        'ui-control-medium': 'var(--ui-control-width-medium)',
        'ui-control-large': 'var(--ui-control-width-large)',
        'ui-table-small': 'var(--ui-table-column-small)',
        'ui-table-medium': 'var(--ui-table-column-medium)',
        'ui-table-large': 'var(--ui-table-column-large)',
      },
      minWidth: {
        'ui-table-small': 'var(--ui-table-column-small)',
        'ui-table-medium': 'var(--ui-table-column-medium)',
