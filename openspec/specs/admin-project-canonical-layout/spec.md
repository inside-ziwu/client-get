# admin-project-canonical-layout Specification

## Purpose
Define the canonical location, package name, and build/deploy wiring for the Admin frontend after the Next.js rewrite became the formal Admin implementation.
