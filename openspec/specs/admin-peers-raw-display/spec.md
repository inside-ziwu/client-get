# admin-peers-raw-display Specification

## Purpose
Define the Admin raw peer-company display contract so the Next.js page uses V3 Lixiaoyun raw company fields and preserves fallback behavior for English names and contact counts.
