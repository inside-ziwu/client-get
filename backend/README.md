...
FastAPI + PostgreSQL + Alembic + 后台 worker。**完整文档见根目录 [README.md](../README.md)**（环境与部署 §7、运维脚本速查 §9）；编码规范、分层、数据库与迁移纪律、行为口径见 [.trellis/spec/backend/](../.trellis/spec/backend/index.md)。
...
生产部署走 GitHub Actions `workflow_dispatch` → 阿里云 ACR → Sealos（详见 README §7）；生产数据库操作纪律见 [AGENTS.md](../AGENTS.md) §1 与 [.trellis/spec/guides/production-operations.md](../.trellis/spec/guides/production-operations.md)。
